...
const axios_1 = __webpack_require__(4);
const vscode = __webpack_require__(2);
const getDocumentLanguage_1 = __webpack_require__(57);
const codeSearch = vscode.commands.registerCommand('code-search', () => {
    ...
    getInsertString().then(res => {
        ...
        let snippet = new vscode.SnippetString(snippetString);
...
const codeSearch_ext_1 = __webpack_require__(56);
function activate(context) {
    context.subscriptions.push(codeSearch_ext_1.default);
